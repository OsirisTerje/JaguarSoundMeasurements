...
def process(file,result):
    ...
    result.append((file,smaxfr,smaxv))


result = []

process("EinarBil-1K0",result)
process("EinarBil-1K2",result)
process("EinarBil-1K4",result)
process("EinarBil-1K6",result)
process("EinarBil-1K8",result)
process("EinarBil-2K0",result)
process("EinarBil-2K2",result)
process("EinarBil-2K4",result)
process("EinarBil-2K6",result)
process("EinarBil-2K8",result)
process("EinarBil-3K0",result)
